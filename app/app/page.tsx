...
export default function Page() {
  return (
    <main className="mx-auto max-w-5xl space-y-6 p-6">
      ...
      <h1 className="text-3xl font-semibold">Logres workspace</h1>
      <p className="max-w-3xl text-slate-700">
        Authenticated workspace entry point for synthetic and future provider-backed sessions.
        Development authentication is blocked in production.
      </p>
