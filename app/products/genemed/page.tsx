...
export default function Page() {
  return (
    <main className="mx-auto max-w-5xl space-y-6 p-6">
      ...
      <h1 className="text-3xl font-semibold">Genemed by Logres</h1>
      <p className="max-w-3xl text-slate-700">
        Genemed provides research-use phenotype-associated candidate gene ranking on the Logres
        platform while clinical use remains blocked.
      </p>
