...
export default function Page() {
  return (
    <main className="mx-auto max-w-5xl space-y-6 p-6">
      ...
      <h1 className="text-3xl font-semibold">Products on Logres</h1>
      <p className="max-w-3xl text-slate-700">
        Genemed is currently the first registered Logres product. Future products must complete
        their own privacy, security, data, and release profiles before activation.
      </p>
